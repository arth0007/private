...
if(isset($_GET['delete'])){
  $id = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `vendor_account` WHERE `id` = $id";
...
if (isset( $_POST['idEdit'])){
  ...
  $sql = "UPDATE `vendor_account` SET `Name` = '$Name' ,`Account_no` = '$Account_no' , `IFSC_CODE` = '$IFSC_CODE', `Branch_Name` = '$Branch_Name'  WHERE `vendor_account`.`id` = $id";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `vendor_account` (`Name`,`Account_no`, `IFSC_CODE`, `Branch_Name`) VALUES ('$Name','$Account_no', '$IFSC_CODE', '$Branch_Name')";
  $result = mysqli_query($conn, $sql);
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/penny_drop/Saved-Account.php" method="POST">
          <div class="modal-body">
            <input type="hidden" name="idEdit" id="idEdit">
            <div class="form-group">
              <label for="name"><b>Name<b></label>
              <input type="text" class="form-control" id="NameEdit" name="NameEdit" aria-describedby="emailHelp"  autocomplete="off">
            </div>
            <br>
            <div class="form-group">
...
<div class="modal fade" id="csv_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
<form class="form-horizontal" action="functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editModalLabel">Select CSV FILE</h5>
          <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>-->
...
<div class="modal fade" id="account_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="forms-sample" action="/penny_drop/Saved-Account.php" method="post" onsubmit="return validate()" >
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="reaccount_no" name="reaccount_no" placeholder="Retype your Account no" onkeyup="check(this)"   autocomplete="off" required>
                      <error id="alert" style="    color: #f00;"></error>
                    </div>
                   <br>
                    <div class="form-group">
                      <label for="exampleInputEmail1">IFSC CODE</label>
                      <input type="text" class="form-control" id="IFSC_CODE" name="IFSC_CODE" placeholder="Enter your IFSC Code"  autocomplete="off" required>
                    </div>
                    <br>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Branch name</label>
                      <input type="text" class="form-control" id="Branch_Name" name="Branch_Name" placeholder="Enter your Branch name"  autocomplete="off" required>
                    </div>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Saved-Account.php">
          <i class="bi bi-grid"></i>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Vendor Account</h5>
                ...
                <button type="button" class="btn btn-warning me-md-2" data-bs-toggle="modal" data-bs-target="#csv_modal">Bulk upload</button>
                <button  class="btn-success float-end" data-bs-toggle="modal" data-bs-target="#account_modal">Add</button>
                  ...
                  <!--<div clas="row">
                  <div class="col-md-12">
                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#csv_modal">Bulk upload</button>
                </div>-->
              <!--</div>
                <div class="row" >
                      <div class="col-md-14">
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><input type="submit" value="Delete" onlick="return confirm('ARE SURE YOU WANT TO DELETE')" class=" btn btn-danger">
                    
                  </tr>
                </thead>
                <tbody>
                <?php 
                    $sql = "SELECT * FROM `vendor_account`";
                    $result = mysqli_query($conn, $sql);
                    $id = 0;
  ...
  <script>
    ...
    Array.from(edits).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        console.log(Name, Account_no, IFSC_CODE, Branch_Name);
        NameEdit.value = Name;
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/penny_drop/Saved-Account.php?delete=${id}`;
